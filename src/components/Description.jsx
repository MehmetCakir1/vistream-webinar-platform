...
const Description = () => {
  return (
    <>
    <div className='bg-[#F7F8FB] w-full pb:[2rem] md:pb-[5rem] mt-[3rem]'>
         <div className='text-center max-w-[60rem] m-auto '>
      <h1 className='text-[#232b76] text-xl md:text-[40px] font-bold py-3'>WHAT IS VISTREAM WEBINAR PORTAL</h1>
      <h3 className='text-[#232b76] text-xl md:text-[31px] md:leading-[2.5rem] py-3'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto.</h3>
      <div className='w-[80%] max-w-[436px] py-1 bg-[#042164] m-auto mt-5'></div>
    </div>
    </div>
    
    <div className='grid md:grid-cols-3 max-w-[80rem] m-auto mt-[4rem] md:mt-[10rem] gap-7 md:gap-3 px-2 md:px-0'>
