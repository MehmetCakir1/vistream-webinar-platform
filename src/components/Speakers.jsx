  ...
  return (
    <main>
      ...
      <div className='flex justify-center items-center gap-5 py-2'>
        <button className={`${date=="Wednesday, 25 February 2021" ? "bg-[#232B76] text-white " : "bg-white text-[#232B76] border border-[#232B76]"} rounded-3xl md:px-5 py-2 transition-all 800ms ease-linear text-[12px] md:text-[16px] px-2`}
        onClick={(e)=>changeTheDate(e)}
        >Wednesday, 25 February 2021</button>
        <button className={`${date=="Wednesday, 26 February 2021" ? "bg-[#232B76] text-white " : "bg-white text-[#232B76] border border-[#232B76]"} rounded-3xl md:px-5 py-2 transition-all 800ms ease-linear text-[12px] md:text-[16px] px-2`}
        onClick={(e)=>changeTheDate(e)}
