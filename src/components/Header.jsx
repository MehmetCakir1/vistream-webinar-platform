...
const Header = () => {
  const [days, hours, minutes, seconds] = useCountdown("Wednesday, 12 March 2023,15:00");
  ...
  return (
    <header className="header h-[500px] 2xl:h-[721px] w-full max-w-[1920px] m-auto flex flex-col lg:flex-row justify-center items-center gap-8">
      <section className='max-w-[780px] 2xl:translate-x-[-7rem] '>
        ...
        <h2 className='text-white text-xl lg:text-[30px] pb-7 2xl:pb-9 px-2 md:px-0'>Wednesday, 05 March 2023,15:00</h2>
